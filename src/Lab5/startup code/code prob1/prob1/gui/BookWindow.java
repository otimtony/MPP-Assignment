...
public class BookWindow extends JFrame {
	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt){
			JOptionPane.showMessageDialog(Lab5.codeprob1.prob1.gui.BookWindow.this, "Still need to check book rules!");
		}
	}
	...
	public static void main(String[] args){
		Lab5.codeprob1.prob1.gui.BookWindow mf = new Lab5.codeprob1.prob1.gui.BookWindow();
		//mf.pack();
		mf.setVisible(true);
	}
}
