...
public class CDWindow extends JFrame {
	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt){
			JOptionPane.showMessageDialog(Lab5.codeprob1.prob1.gui.CDWindow.this, "Still need to check CD rules!");
		}
	}
	...
	public static void main(String[] args){
		Lab5.codeprob1.prob1.gui.CDWindow mf = new Lab5.codeprob1.prob1.gui.CDWindow();
		//mf.pack();
		mf.setVisible(true);
	}
}
