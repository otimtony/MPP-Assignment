...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Do any of these Order Items have an order of flowers? " + 
		   m.findProductUsingOption("Flowers"));
	}
	...
	private boolean findProductUsingOption(String productName) {

		return orderItems.stream().filter(o -> o.getProduct().getProductName().equals(productName))
				.findFirst().isPresent();
	}
